...
public class AdvertTypesService {
    ...
    private AdvertType isAdvertTypeById(Long id) {
        ...
        public  ResponseMessage<AdvertTypesResponse> saveAdvertTypes(AdvertTypeRequest advertTypeRequest) {

            AdvertType advertType= new AdvertType();
            if(Objects.equals(advertTypeRequest.getTitle().toUpperCase(),"RENT")){
                advertType.setTitle(AdvertTypes.RENT);
            }
            else if(Objects.equals(advertTypeRequest.getTitle().toUpperCase(),"SALE")){
                advertType.setTitle(AdvertTypes.SALE);
            }
            else {
                throw new BadRequestException(ErrorMessages.ADVERT_TYPE_NOT_VALID);
            }
